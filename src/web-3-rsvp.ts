...
export function handleNewEventCreated(event: NewEventCreated): void {
  let newEvent = Event.load(event.params.eventID.toHexString());
  if(newEvent == null){
...
function getOrCreateAccout(address: Address): Account{
...
export function handleNewRSVP(event: NewRSVP): void {
  ...
  let account = getOrCreateAccout(event.params.attendeeAddress);
